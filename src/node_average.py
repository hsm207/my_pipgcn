...
from utils.models import NodeAverageModel


def model_fn(features, labels, mode, params):
    np.random.seed(params['np_seed'])
    model = NodeAverageModel(params['layer_config'])
...
params = {'layer_config': [256], 'model_name': 'node_avg_1_layer', 'model_dir': '../model_dir/node_average'}
