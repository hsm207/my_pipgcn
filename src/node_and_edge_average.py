...
from utils.models import NodeAverageEdgeModel


def model_fn(features, labels, mode, params):
    np.random.seed(params['np_seed'])
    model = NodeAverageEdgeModel(params['layer_config'])
...
params = {'layer_config': [256], 'model_name': 'node_and_edge_avg_1_layer',
          'model_dir': '../model_dir/node_and_edge_average'}
